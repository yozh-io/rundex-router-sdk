  ...
  return (
    ...
    (t.encodeAddLiquidity = function (e, r, o, u) {
      ...
      return (
        ...
        n.lessThan(r.amount1.quotient, s) && (s = r.amount1.quotient),
        v(o)
    ...
    (I.prototype = {
      ...
      finish: function (t) {
        for (var e = this.tryEntries.length - 1; e >= 0; --e) {
          ...
          if (n.finallyLoc === t) return this.complete(n.completion, n.afterLoc), g(n), p
        }
      },
      catch: function (t) {
        for (var e = this.tryEntries.length - 1; e >= 0; --e) {
...
;(E.INTERFACE = new r.Interface(s.abi)), ((w = exports.Protocol || (exports.Protocol = {})).V2 = 'V2'), (w.V3 = 'V3')
var O = (function (t) {
    function e(e) {
      var n
      return (
  ...
  _ = (function () {
    function t(t) {
      ...
      for (var c, s = N(e); !(c = s()).done; ) {
        var p = c.value,
          l = p.inputAmount,
          f = p.outputAmount,
          m = new O(p.routev2)
        this.routes.push(m), this.swaps.push({ route: m, inputAmount: l, outputAmount: f })
      }
      for (var h, v = N(n); !(h = v()).done; ) {
        var y = h.value,
          A = y.inputAmount,
          T = y.outputAmount,
          w = new R(y.routev3)
        this.routes.push(w), this.swaps.push({ route: w, inputAmount: A, outputAmount: T })
      }
      this.tradeType = r
      var E = this.swaps[0].inputAmount.currency,
        x = this.swaps[0].outputAmount.currency
      this.swaps.every(function (t) {
        return E.wrapped.equals(t.route.input.wrapped)
      }) || o(!1),
        this.swaps.every(function (t) {
          return x.wrapped.equals(t.route.output.wrapped)
        }) || o(!1)
      for (
        var g,
          I = this.swaps
        ...
        for (var _, F = g.value.route, b = N(F.pools); !(_ = b()).done; ) {
          var M = _.value
          F.protocol == exports.Protocol.V3
            ? P.add(i.Pool.getAddress(M.token0, M.token1, M.fee))
            : P.add(d.Pair.getAddress(M.token0, M.token1, u, a))
        }
      I != P.size && o(!1)
    }
    var e,
    ...
    return (
      (r.minimumAmountOut = function (t, e) {
        if (
          (void 0 === e && (e = this.outputAmount), t.lessThan(m) && o(!1), this.tradeType === c.TradeType.EXACT_OUTPUT)
        )
          return e
      ...
      (r.maximumAmountIn = function (t, e) {
        if (
          (void 0 === e && (e = this.inputAmount), t.lessThan(m) && o(!1), this.tradeType === c.TradeType.EXACT_INPUT)
        )
          return e
      ...
      (t.fromRoutes = (function () {
        var e = I(
          x().mark(function e(n, r, o, u, a) {
            var c, s, p, l, f, m, h, v, y, A, T, w, E
            return x().wrap(function (e) {
              for (;;)
                switch ((e.prev = e.next)) {
                  case 0:
                    for (c = [], s = [], p = N(n); !(l = p()).done; )
                      (h = new d.Trade((m = (f = l.value).routev2), f.amount, o)),
                        c.push({ routev2: m, inputAmount: h.inputAmount, outputAmount: h.outputAmount })
                    v = N(r)
                  case 4:
                    if ((y = v()).done) {
                      e.next = 13
                    ...
                    return (T = (A = y.value).routev3), (w = A.amount), (e.next = 8), i.Trade.fromRoute(T, w, o)
                  case 8:
                    s.push({ routev3: T, inputAmount: (E = e.sent).inputAmount, outputAmount: E.outputAmount })
                  case 11:
                    e.next = 4
                    break
                  case 13:
                    return e.abrupt(
                      'return',
                      new t({ v2Routes: c, v3Routes: s, tradeType: o, factoryAddress: u, initCodeHash: a })
                    )
                  case 14:
                  case 'end':
                    return e.stop()
              ...
              for (;;)
                switch ((e.prev = e.next)) {
                  case 0:
                    ...
                    ;(p = new d.Trade(n, r, o)),
                      (c = [{ routev2: n, inputAmount: p.inputAmount, outputAmount: p.outputAmount }]),
                      (s = []),
                      (e.next = 13)
                    break
                  case 7:
                  ...
                  case 9:
                    ;(s = [{ routev3: n, inputAmount: (l = e.sent).inputAmount, outputAmount: l.outputAmount }]),
                      (c = [])
                  case 13:
                    return e.abrupt(
                      'return',
      ...
      (n = [
        ...
        },
        {
          ...
          get: function () {
            ...
            for (
              var t, e = c.CurrencyAmount.fromRawAmount(this.outputAmount.currency, 0), n = N(this.swaps);
              !(t = n()).done;
  ...
  F = n.BigInt(0),
  b = new c.Percent(n.BigInt(50), n.BigInt(100)),
  M = (function () {
    function t() {}
    return (
      (t.encodeV2Swap = function (e, n, r, o) {
        var u = i.toHex(e.maximumAmountIn(n.slippageTolerance).quotient),
          ...
          p = r ? f : void 0 === n.recipient ? l : c.validateAndParseAddress(n.recipient)
        return e.tradeType === c.TradeType.EXACT_INPUT
          ? t.INTERFACE.encodeFunctionData('swapExactTokensForTokens', [u, o ? 0 : a, s, p])
          : t.INTERFACE.encodeFunctionData('swapTokensForExactTokens', [a, u, s, p])
      }),
      (t.encodeV3Swap = function (e, n, r, o) {
        for (var u, a = [], s = N(e.swaps); !(u = s()).done; ) {
          var p = u.value,
            d = p.route,
            m = p.outputAmount,
            ...
            a.push(
              e.tradeType === c.TradeType.EXACT_INPUT
                ? t.INTERFACE.encodeFunctionData('exactInput', [
                    { path: T, recipient: A, amountIn: h, amountOutMinimum: o ? 0 : v },
                  ])
                : t.INTERFACE.encodeFunctionData('exactOutput', [
                    { path: T, recipient: A, amountOut: v, amountInMaximum: h },
                  ])
            )
          }
        }
      ...
      (t.encodeSwaps = function (e, n, r) {
        if (e instanceof _) {
          ...
          for (var u, a = [], s = N(e.swaps); !(u = s()).done; ) {
            ...
            l.protocol == exports.Protocol.V2
              ? a.push(new d.Trade(l, e.tradeType == c.TradeType.EXACT_INPUT ? f : m, e.tradeType))
              : l.protocol == exports.Protocol.V3 &&
                a.push(
                  i.Trade.createUncheckedTrade({ route: l, inputAmount: f, outputAmount: m, tradeType: e.tradeType })
                )
          }
          e = a
        }
        ...
        var y = [],
          ...
          E = T || !!n.fee || !!r || w
        n.inputTokenPermit &&
          (v.inputAmount.currency.isToken || o(!1),
          y.push(i.SelfPermit.encodePermit(v.inputAmount.currency, n.inputTokenPermit)))
        for (var x, g = N(e); !(x = g()).done; ) {
          var I = x.value
          if (I instanceof d.Trade) y.push(t.encodeV2Swap(I, n, E, w))
          else for (var P, k = N(t.encodeV3Swap(I, n, E, w)); !(P = k()).done; ) y.push(P.value)
        }
        var O = c.CurrencyAmount.fromRawAmount(v.inputAmount.currency, 0),
          R = c.CurrencyAmount.fromRawAmount(v.outputAmount.currency, 0),
      ...
      (t.swapCallParameters = function (e, n) {
        ...
        return (
          r.routerMustCustody &&
            o.push(
              r.outputIsNative
                ? E.encodeUnwrapWETH9(p.quotient, n.recipient, n.fee)
                : E.encodeSweepToken(u.outputAmount.currency.wrapped, p.quotient, n.recipient, n.fee)
            ),
          a &&
            (u.tradeType === c.TradeType.EXACT_OUTPUT || t.riskOfPartialFill(e)) &&
            o.push(i.Payments.encodeRefundETH()),
          { calldata: A.encodeMulticall(o, n.deadlineOrPreviousBlockhash), value: i.toHex(a ? s.quotient : F) }
        )
      }),
      (t.swapAndAddCallParameters = function (e, n, r, u, a, s) {
        var p = t.encodeSwaps(e, n, !0),
          ...
          h = p.totalAmountIn,
          v = p.quoteAmountOut,
          T = p.minimumAmountOut
        n.outputTokenPermit &&
          (v.currency.isToken || o(!1), d.push(i.SelfPermit.encodePermit(v.currency, n.outputTokenPermit)))
        var w = m.route.chainId,
          ...
          k = l ? c.WETH9[w] : I.currency.wrapped,
          N = f ? c.WETH9[w] : P.currency.wrapped,
          O = P.subtract(v.wrapped)
        O.greaterThan(c.CurrencyAmount.fromRawAmount(P.currency, 0)) &&
          d.push(f ? E.encodeWrapETH(O.quotient) : E.encodePull(N, O.quotient)),
          d.push(l ? E.encodeWrapETH(I.quotient) : E.encodePull(k, I.quotient)),
          a !== exports.ApprovalTypes.NOT_REQUIRED && d.push(y.encodeApprove(k, a)),
          s !== exports.ApprovalTypes.NOT_REQUIRED && d.push(y.encodeApprove(N, s))
        var R,
          _ = i.Position.fromAmounts({
            pool: r.pool,
        ...
        return (
          d.push(y.encodeAddLiquidity(r, _, u, n.slippageTolerance)),
          d.push(l ? E.encodeUnwrapWETH9(F) : E.encodeSweepToken(k, F)),
          d.push(f ? E.encodeUnwrapWETH9(F) : E.encodeSweepToken(N, F)),
          (R = l ? h.wrapped.add(I.wrapped).quotient : f ? O.quotient : F),
          { calldata: A.encodeMulticall(d, n.deadlineOrPreviousBlockhash), value: R.toString() }
        )
      }),
...
;(M.INTERFACE = new r.Interface(p.abi)),
  (exports.ADDRESS_THIS = f),
  (exports.ApproveAndCall = y),
  (exports.MSG_SENDER = l),
  (exports.MulticallExtended = A),
  (exports.ONE = h),
  (exports.PaymentsExtended = E),
  (exports.RouteV2 = O),
  (exports.RouteV3 = R),
