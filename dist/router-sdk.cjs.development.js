...
var Trade = /*#__PURE__*/function () {
    ...
    for (var _iterator3 = _createForOfIteratorHelperLoose(this.swaps), _step3; !(_step3 = _iterator3()).done;) {
      ...
      for (var _iterator4 = _createForOfIteratorHelperLoose(_route2.pools), _step4; !(_step4 = _iterator4()).done;) {
        ...
        if (_route2.protocol == exports.Protocol.V3) {
          ...
          var pair = pool;
          poolAddressSet.add(v2Sdk.Pair.getAddress(pair.token0, pair.token1, factoryAddress, initCodeHash));
        }
      }
    }
  ...
  Trade.fromRoutes = /*#__PURE__*/function () {
    var _fromRoutes = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(v2Routes, v3Routes, tradeType, factoryAddress, initCodeHash) {
  ...
  Trade.fromRoute = /*#__PURE__*/function () {
    var _fromRoute = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(route, amount, tradeType, factoryAddress, initCodeHash) {
    ...
    function fromRoute(_x6, _x7, _x8, _x9, _x10) {
