...
export declare class Trade<TInput extends Currency, TOutput extends Currency, TTradeType extends TradeType> {
    ...
    constructor({ v2Routes, v3Routes, tradeType, factoryAddress, initCodeHash }: {
        v2Routes: {
    ...
    static fromRoutes<TInput extends Currency, TOutput extends Currency, TTradeType extends TradeType>(v2Routes: {
        ...
        routev3: V3RouteSDK<TInput, TOutput>;
        amount: TTradeType extends TradeType.EXACT_INPUT ? CurrencyAmount<TInput> : CurrencyAmount<TOutput>;
    }[], tradeType: TTradeType, factoryAddress: string, initCodeHash: string): Promise<Trade<TInput, TOutput, TTradeType>>;
    static fromRoute<TInput extends Currency, TOutput extends Currency, TTradeType extends TradeType>(route: V2RouteSDK<TInput, TOutput> | V3RouteSDK<TInput, TOutput>, amount: TTradeType extends TradeType.EXACT_INPUT ? CurrencyAmount<TInput> : CurrencyAmount<TOutput>, tradeType: TTradeType, factoryAddress: string, initCodeHash: string): Promise<Trade<TInput, TOutput, TTradeType>>;
}
